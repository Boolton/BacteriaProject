...
#Plotting growth rate over temperature
    ...
    plt.title("Growth rate as a function of temperature",fontsize=18)
    plt.xlabel("Temperature",fontsize=12)
    plt.ylabel("Growth rate",fontsize=12)
    plt.legend(['Salmonella enterica', 'Bacillus cereus', 'Listeria', 'Brochothrix thermosphacta'],bbox_to_anchor=(1.05, 1), loc='upper left', borderaxespad=0.)
    plt.savefig('GrowthTemp')
    plt.show()